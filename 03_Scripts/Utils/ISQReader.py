...
def WriteMHD(ImageArray, AdditionalData, Path, FileName, PixelType='uint'):
...
if __name__ == '__main__':
    ...
    Parser.add_argument('--Info', default=False, help='Write general information file', type=bool)
